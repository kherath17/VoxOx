...
import pageFunctions.signUpLandoCPFn;
import pageObjects.signUpPage;

import java.io.IOException;

public class stepDefenitions_SignUp {
    signUpPage sp = new signUpPage();
    signUpLandoCPFn lFn = new signUpLandoCPFn();

    //added assertion
    @Given("User to navigate the landingPage")
    public void user_to_navigate_the_cloudphone_com() throws InterruptedException, IOException {
